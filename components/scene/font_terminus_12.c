 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --bpp 1 --size 12 --no-compress --stride 1 --align 1 --font TerminusTTF-4.49.3.ttf --range 0-127 --format lvgl -o font_terminus_12.c.c
 ******************************************************************************/
#ifdef __has_include
...
#ifndef FONT_TERMINUS_12
#define FONT_TERMINUS_12 1
#endif
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap_terminus[] = {
    /* U+0000 "\u0000" */
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc_terminus[] = {
...
static const lv_font_fmt_txt_cmap_t cmaps_terminus[] =
    {
...
#if LVGL_VERSION_MAJOR >= 8
static const lv_font_fmt_txt_dsc_t font_dsc_terminus = {
#else
static lv_font_fmt_txt_dsc_t font_dsc_terminus = {
#endif
    .glyph_bitmap = glyph_bitmap_terminus,
    .glyph_dsc = glyph_dsc_terminus,
    .cmaps = cmaps_terminus,
    .kern_dsc = NULL,
    .kern_scale = 0,
    .cmap_num = 2,
    .bpp = 1,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_terminus_12 = {
#else
lv_font_t font_terminus_12 = {
#endif
...
#endif
    // .static_bitmap = 0,
    .dsc = &font_dsc_terminus, /*The custom font data. Will be accessed by `get_glyph_bitmap/dsc` */
